...
- **Device Actions** — `set_alarm` on the user's phone, dispatched to the companion app via the `device_action` `/ws/chat` event. See [MCP Device Actions](services/agent/tools/device-action.md).
