...
| Device Actions | 1 — `set_alarm` on the user's phone, dispatched to the companion app via the `device_action` wire-protocol event | [tools/device-action.md](tools/device-action.md) |
