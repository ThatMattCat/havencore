...
| [Text-to-Speech](text-to-speech/README.md) | 6005 | Speech synthesis — Chatterbox-Turbo, expressive + voice cloning + streaming | Python, Chatterbox-TTS, CUDA |
...
agent → text-to-speech:6005     (TTS — Chatterbox-Turbo)
